...
Ta tâche :
1. Identifier toutes les anomalies (doublons, valeurs manquantes, espaces, formats, valeurs aberrantes, etc.)
2. Pour CHAQUE anomalie, proposer UNE opération de la liste ci-dessus
3. Spécifier les paramètres exacts à passer à la fonction
...
{{
    "anomalies": [
        {{
            ...
            "colonnes_affectees": ["col1", "col2"],
            "operation": "nom_exact_de_la_fonction",
            "parametres": {{
                "param1": "valeur1",
                "param2": "valeur2"
            }},
            "impact_estime": "description de l'impact"
        }}
    ]
}}

IMPORTANT : Les noms d'opération doivent correspondre EXACTEMENT à ceux de la liste ci-dessus.
"""
